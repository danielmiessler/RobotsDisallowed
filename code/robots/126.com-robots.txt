...
.title{background-color:#0A8745;font-weight:bold;color:#fff;padding:6px 10px 8px 7px;}
...
<div class="errMainArea" >
	...
	<p class="txt_title" >对不起，你找的文件服务器上找不到 !</p></div><div class="errBtmArea">
    <input type="button" class="btnFn1" value="返回首页" onclick="location.href='http://www.126.com/'" />
  </div>
